...
using CommGate.Data.Repositories;
    ...
    public class Startup
    {
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments($"{AppDomain.CurrentDomain.BaseDirectory}\\CommGate.WebAPI.xml");
        ...
        private void UserSwagger(IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint(virtualDirectory + "swagger/v1/swagger.json", "CommGate Web API V1");
        ...
        {
            const string databaseConnectionKeyName = "DefaultConnection";
